...
class Browser {
  ...
  open(uri, encoding = 'UTF-8', agent = null, skip = false) {
    return new Promise((resolve, reject) => {
      ...
      this.request(params, (err, response, body) => {
        ...
        if(encoding) {
          ...
          let docCharacterSet = this._documentCharset(doc, skip) || 'UTF-8';
  ...
  _documentCharset(html, skip) {
    if (skip === true) return 'UTF-8'; // G마켓 케이스
