...
class Ep {
  ...
  _fields() {
    return ['id', 'title', 'price_pc', 'price_mobile', 'normal_price', 'link', 'mobile_link', 'image_link', 'category_name1', 'category_name2', 'category_name3', 'category_name4', 'brand', 'review_count', 'shipping', 'card_event', 'sale_start', 'sale_end'];
  }
